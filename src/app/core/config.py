...
def get_public_key() -> rsa.RSAPublicKey:
  """Get the RSA public key derived from the cached private key."""
...
class Settings(BaseSettings):
  ...
  def RATE_LIMITS(self) -> Dict[str, str]:
    return {
      "admins": self.RATE_LIMIT_ADMIN,
      "students": self.RATE_LIMIT_STUDENT,
      "teachers": self.RATE_LIMIT_TEACHER,
